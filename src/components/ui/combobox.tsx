    ...
    <Popover open={open} onOpenChange={setOpen}>
      ...
      >
        <Command>
          ...
          <CommandGroup className="max-h-60 overflow-y-auto scrollbar-thin scrollbar-thumb-white/20 scrollbar-track-transparent">
            {options.map((option) => (
              <CommandItem
                key={option.value}
                value={option.value}
                ...
                className={cn(
                  ...
                  value === option.value && "bg-blue-500/20 text-blue-300 dark:text-blue-400",
                )}
              >
