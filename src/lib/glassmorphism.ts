...
export const glassmorphism = {
  ...
  cardHover: "hover:bg-white/10 dark:hover:bg-black/30 hover:border-white/20 dark:hover:border-white/10 transition-all duration-300",
  
  // Glass containers
  container: "backdrop-blur-xl bg-white/5 dark:bg-black/10 border border-white/10 dark:border-white/5",
  
  // Glass overlays
  overlay: "backdrop-blur-sm bg-black/20 dark:bg-black/40",
  
  // Glass buttons
  button: "backdrop-blur-md bg-white/10 dark:bg-black/20 border border-white/20 dark:border-white/10 hover:bg-white/20 dark:hover:bg-black/30",
  
  // Glass inputs
  input: "backdrop-blur-md bg-white/5 dark:bg-black/20 border border-white/20 dark:border-white/10 focus:border-white/40 dark:focus:border-white/20",
  
  // Glass navigation
  nav: "backdrop-blur-xl bg-white/10 dark:bg-black/20 border-b border-white/10 dark:border-white/5",
  
  // Glass modals
  modal: "backdrop-blur-2xl bg-white/10 dark:bg-black/30 border border-white/20 dark:border-white/10 shadow-2xl",
  
  // Glass dropdowns
  dropdown: "backdrop-blur-lg bg-white/90 dark:bg-black/80 border border-white/20 dark:border-white/10 shadow-xl",
  
  // Glass filters
  filter: "backdrop-blur-md bg-white/8 dark:bg-black/25 border border-white/15 dark:border-white/8",
};

// Gradient backgrounds for glassmorphism
export const glassGradients = {
  primary: "bg-gradient-to-br from-blue-500/20 via-purple-500/20 to-pink-500/20",
  secondary: "bg-gradient-to-br from-cyan-500/15 via-teal-500/15 to-green-500/15",
...
export function createGlassStyle(opacity: number = 0.1, blur: number = 12) {
